...
const TABS = [
  { title: "تفاصيل المهمه", icon: <FaTasks /> },
...
const TaskDetails = () => {
  ...
  return (
    <div className='w-full flex flex-col gap-3 mb-4 overflow-y-hidden'>
      <h1 className='text-2xl text-gray-100 font-bold'>{task?.title}</h1>
      ...
      <Tabs tabs={TABS} setSelected={setSelected}>
        {selected === 0 ? (
              ...
              <div className='w-full md:w-1/2 space-y-8'>
                <div className='flex items-center gap-5'>
                  ...
                  >
                    ...
                    <span className='uppercase'>أولويه{task?.priority}</span>
                  </div>
                ...
                <p className='text-gray-500 text-right'>
                   أٌنشاء: {new Date(task?.date).toDateString()}
                </p>

                <div className='flex items-center gap-8 p-4 border-y border-gray-200'>
                  <div className='space-x-2'>
                    <span className='font-semibold'>صور المهمه :</span>
          ...
          <>
            <Activities activity={data?.task?.activities} id={id} />
          </>
        )}
      </Tabs>
    </div>
